...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal static partial class ErrorFacts
    {
        ...
        private static readonly Lazy1<ImmutableDictionary<ErrorCode, string>> s_helpLinksMap = new Lazy1<ImmutableDictionary<ErrorCode, string>>(CreateHelpLinks);
        private static readonly Lazy1<ImmutableDictionary<ErrorCode, string>> s_categoriesMap = new Lazy1<ImmutableDictionary<ErrorCode, string>>(CreateCategoriesMap);
        ...
        {
            return (id.ToString());//ResourceManager.GetString(id.ToString(), culture);
        }

...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed class MessageProvider : CommonMessageProvider, IObjectWritable
    {
        ...
        {
            var info = new CSDiagnosticInfo((ErrorCode)code, args, ImmutableArray<object>.Empty, ImmutableArray<Location>.Empty);
        ...
        public override ReportDiagnostic GetDiagnosticReport(DiagnosticInfo diagnosticInfo)
        {
        ...
        public override string GetErrorDisplayString(object symbol)
        {

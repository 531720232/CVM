        ...
        public void Serialize(System.IO.BinaryWriter writer)
        {
            switch (this.Discriminator)
            {
                case ConstantValueTypeDiscriminator.Boolean:
                    writer.Write(this.BooleanValue);
                    break;

                case ConstantValueTypeDiscriminator.SByte:
                    writer.Write(this.SByteValue);
                    break;

                case ConstantValueTypeDiscriminator.Byte:
                    writer.Write(this.ByteValue);
                    break;

                case ConstantValueTypeDiscriminator.Char:
                case ConstantValueTypeDiscriminator.Int16:
                    writer.Write(this.Int16Value);
                    break;

                case ConstantValueTypeDiscriminator.UInt16:
                    writer.Write(this.UInt16Value);
                    break;

                case ConstantValueTypeDiscriminator.Single:
                    writer.Write(this.SingleValue);
                    break;

                case ConstantValueTypeDiscriminator.Int32:
                    writer.Write(this.Int32Value);
                    break;

                case ConstantValueTypeDiscriminator.UInt32:
                    writer.Write(this.UInt32Value);
                    break;
                ...
                case ConstantValueTypeDiscriminator.Int64:
                    writer.Write(this.Int64Value);
                    break;

                case ConstantValueTypeDiscriminator.UInt64:
                    writer.Write(this.UInt64Value);
                    break;

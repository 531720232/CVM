...
namespace Microsoft.CodeAnalysis
{
    ...
    internal abstract class CommonMessageProvider
    {
        ...
        /// </summary>
        public abstract string GetErrorDisplayString(object symbol);
        ...
        public DiagnosticInfo FilterDiagnosticInfo(DiagnosticInfo diagnosticInfo)
        {
            var report = this.GetDiagnosticReport(diagnosticInfo);
            switch (report)
            {

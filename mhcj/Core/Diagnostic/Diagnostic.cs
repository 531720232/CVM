...
namespace Microsoft.CodeAnalysis
{
    ...
    public abstract partial class Diagnostic : IEquatable<Diagnostic>, IFormattable
    {
        ...
        public SuppressionInfo GetSuppressionInfo()
        {
            ...
            return new SuppressionInfo(this.Id,null);
        }
        ...
        internal virtual IList<object> Arguments
        {
            get { return SpecializedCollections.EmptyList<object>(); }
        }
        ...
        {
            return true;//    return AnalyzerManager.HasNotConfigurableTag(this.CustomTags);
        }
    }

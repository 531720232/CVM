...
namespace Microsoft.CodeAnalysis
{
    ...
    {
        private readonly Lazy1<ImmutableArray<Diagnostic>> _lazyErrors;
        ...
        internal ParseOptions(SourceCodeKind kind, DocumentationMode documentationMode)
        {
            ...
            _lazyErrors = new Lazy1<ImmutableArray<Diagnostic>>(() =>
            {
        ...
        /// </summary>
        public abstract IDictionary<string, string> Features
        {
            get;
        }
        ...
        private static int HashFeatures(IDictionary<string, string> features)
        {
            int value = 0;

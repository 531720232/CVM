...
namespace Microsoft.CodeAnalysis.CSharp.Syntax.InternalSyntax
{
    ...
    internal partial class Lexer : AbstractLexer
    {
            ...
            : base(text)
        {
            ...
            _options = options.WithPreprocessorSymbols(CVM.GlobalDefine.Instance.defines);
        ...
        private void CheckFeatureAvailability(MessageID feature)
        {
            ...
            this.AddError(availableVersion.GetErrorCode(), featureName, (requiredVersion));
        }
        ...
        private void ScanXmlEntity(ref TokenInfo info)
        {
            ...
            if (error != null)
            {
                this.AddError(error.Value, errorArgs ?? new object[0]);
            }
        }

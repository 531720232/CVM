...
namespace Microsoft.Cci
{
    ...
    internal interface IReference
    {
        ...
        /// </summary>
        IEnumerable<ICustomAttribute> GetAttributes(CodeAnalysis.Emit.EmitContext context); // TODO: consider moving this to IDefinition, we shouldn't need to examine attributes on references.
        ...
        /// </summary>
        IDefinition AsDefinition(CodeAnalysis.Emit.EmitContext context);
    }
}

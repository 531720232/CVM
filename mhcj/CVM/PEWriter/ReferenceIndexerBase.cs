...
namespace Microsoft.Cci
{
    internal abstract class ReferenceIndexerBase : MetadataVisitor
    {
        ...
        public void VisitTypeDefinitionNoMembers(ITypeDefinition typeDefinition)
        {
            ...
            {
                this.Visit((IEnumerable<IGenericParameter>)typeDefinition.GenericParameters);
            }
        }
        ...
        public override void Visit(ITypeDefinition typeDefinition)
        {
            ...
            this.VisitNestedTypes((IEnumerable<INamedTypeDefinition>)typeDefinition.GetNestedTypes(Context));

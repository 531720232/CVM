...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal class ControlFlowPass : AbstractFlowPass<ControlFlowPass.LocalState>
    {
        ...
        internal ControlFlowPass(CVM_Zone compilation, Symbol member, BoundNode node)
            : base(compilation, member, node)
        {
        }

        internal ControlFlowPass(CVM_Zone compilation, Symbol member, BoundNode node, BoundNode firstInRegion, BoundNode lastInRegion)
        ...
        /// </summary>
        public static bool Analyze(CVM_Zone compilation, Symbol member, BoundBlock block, DiagnosticBag diagnostics)
        {

...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal class DataFlowsOutWalker : AbstractRegionDataFlowPass
    {
        ...
        private DataFlowsOutWalker(CVM_Zone compilation, Symbol member, BoundNode node, BoundNode firstInRegion, BoundNode lastInRegion, HashSet<Symbol> unassignedVariables, ImmutableArray<ISymbol> dataFlowsIn)
        ...
        internal static HashSet<Symbol> Analyze(CVM_Zone compilation, Symbol member, BoundNode node, BoundNode firstInRegion, BoundNode lastInRegion, HashSet<Symbol> unassignedVariables, ImmutableArray<ISymbol> dataFlowsIn)
        {

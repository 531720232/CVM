...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    {
        internal static IEnumerable<LabeledStatementSyntax> Analyze(CVM_Zone compilation, Symbol member, BoundNode node, BoundNode firstInRegion, BoundNode lastInRegion, out bool? succeeded)
        {
        ...
        private EntryPointsWalker(CVM_Zone compilation, Symbol member, BoundNode node, BoundNode firstInRegion, BoundNode lastInRegion)

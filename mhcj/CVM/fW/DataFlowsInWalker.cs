...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal class DataFlowsInWalker : AbstractRegionDataFlowPass
    {
        ...
        private DataFlowsInWalker(CVM_Zone compilation, Symbol member, BoundNode node, BoundNode firstInRegion, BoundNode lastInRegion,
        ...
        internal static HashSet<Symbol> Analyze(CVM_Zone compilation, Symbol member, BoundNode node, BoundNode firstInRegion, BoundNode lastInRegion,

...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    {
        internal static IEnumerable<Symbol> Analyze(CVM_Zone compilation, Symbol member, BoundNode node, BoundNode firstInRegion, BoundNode lastInRegion)
        {
        ...
        internal VariablesDeclaredWalker(CVM_Zone compilation, Symbol member, BoundNode node, BoundNode firstInRegion, BoundNode lastInRegion)
        ...
        public override void VisitForEachIterationVariables(BoundForEachStatement node)
        {
            if (IsInside)
            {
                ...
                {
                    foreach(var Item in node.IterationVariables)
                    {
                        _variablesDeclared.Add(Item);
                    }
                    //

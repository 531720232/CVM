...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal class ReadWriteWalker : AbstractRegionDataFlowPass
    {
        internal static void Analyze(
            CVM_Zone compilation, Symbol member, BoundNode node, BoundNode firstInRegion, BoundNode lastInRegion, HashSet<PrefixUnaryExpressionSyntax> unassignedVariableAddressOfSyntaxes,
        ...
        private ReadWriteWalker(CVM_Zone compilation, Symbol member, BoundNode node, BoundNode firstInRegion, BoundNode lastInRegion,

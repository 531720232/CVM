...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal class ExitPointsWalker : AbstractRegionControlFlowPass
    {
        ...
        private ExitPointsWalker(CVM_Zone compilation, Symbol member, BoundNode node, BoundNode firstInRegion, BoundNode lastInRegion)
        ...
        internal static IEnumerable<StatementSyntax> Analyze(CVM_Zone compilation, Symbol member, BoundNode node, BoundNode firstInRegion, BoundNode lastInRegion)
        {

...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    {
        private UnassignedVariablesWalker(CVM_Zone compilation, Symbol member, BoundNode node)
            : base(compilation, member, node, new NeverEmptyStructTypeCache())
        {
        }

        internal static HashSet<Symbol> Analyze(CVM_Zone compilation, Symbol member, BoundNode node,

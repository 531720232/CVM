...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    {
        internal static void Analyze(CVM_Zone compilation, Symbol member, BoundNode node, BoundNode firstInRegion, BoundNode lastInRegion,
        ...
        private RegionReachableWalker(CVM_Zone compilation, Symbol member, BoundNode node, BoundNode firstInRegion, BoundNode lastInRegion)

...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    {
        private UnassignedAddressTakenVariablesWalker(CVM_Zone compilation, Symbol member, BoundNode node)
            : base(compilation, member, node)
        {
        }

        internal static HashSet<PrefixUnaryExpressionSyntax> Analyze(CVM_Zone compilation, Symbol member, BoundNode node)
        {

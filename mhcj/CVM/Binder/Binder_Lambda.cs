...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class Binder
    {
        ...
        private CVM.Tuple2<ImmutableArray<RefKind>, ImmutableArray<TypeSymbolWithAnnotations>, ImmutableArray<string>, bool> AnalyzeAnonymousFunction(
            CSharpSyntaxNode syntax, DiagnosticBag diagnostics)
        {
            ...
            return new CVM.Tuple2<ImmutableArray<RefKind>, ImmutableArray<TypeSymbolWithAnnotations>, ImmutableArray<string>, bool>(refKinds, types, names, isAsync);
        }

...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal partial class Binder
    {
        ...
        private static bool IsDeconstructionResultUsed(ExpressionSyntax left)
        {
            ...
            switch (grandParent.Kind())
            {
                ...
                case SyntaxKind.ForStatement:
                    ...
                    return !loop.Incrementors.Contains((ExpressionSyntax)parent) && !loop.Initializers.Contains((ExpressionSyntax)parent);
        ...
        /// </summary>
        private static TypeSymbol MakeMergedTupleType(ArrayBuilder<DeconstructionVariable> lhsVariables, BoundTupleLiteral rhsLiteral, CSharpSyntaxNode syntax, CVM_Zone compilation, DiagnosticBag diagnostics)
        {

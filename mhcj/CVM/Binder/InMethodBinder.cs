...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed class InMethodBinder : LocalScopeBinder
    {
        ...
        internal static TypeSymbolWithAnnotations GetIteratorElementTypeFromReturnType(CVM_Zone compilation, RefKind refKind, TypeSymbol returnType, CSharpSyntaxNode errorLocationNode, DiagnosticBag diagnostics)
        {

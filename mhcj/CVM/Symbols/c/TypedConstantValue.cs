...
namespace Microsoft.CodeAnalysis
{
    ...
    internal struct TypedConstantValue : IEquatable<TypedConstantValue>
    {
        ...
        {
            Debug.Assert(value == null || value is string || value.GetType().IsEnum || (value.GetType().IsPrimitive && !(value is System.IntPtr) && !(value is System.UIntPtr)) || value is ITypeSymbol);
            _value = value;
        }

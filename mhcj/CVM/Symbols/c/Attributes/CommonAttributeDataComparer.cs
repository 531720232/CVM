...
namespace Microsoft.CodeAnalysis
{
    ...
    /// </summary>
    internal sealed class CommonAttributeDataComparer : IEqualityComparer<CSharpAttributeData>
    {
        public static CommonAttributeDataComparer Instance = new CommonAttributeDataComparer();
        private CommonAttributeDataComparer() { }

        public bool Equals(CSharpAttributeData attr1, CSharpAttributeData attr2)
        {
        ...
        public int GetHashCode(CSharpAttributeData attr)
        {
        ...
        private static int GetHashCodeForNamedArguments(IEnumerable<KeyValuePair<string, TypedConstant>> namedArguments)
        {
            int hash = 0;

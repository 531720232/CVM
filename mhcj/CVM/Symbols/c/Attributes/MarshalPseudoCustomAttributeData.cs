...
namespace Microsoft.CodeAnalysis
{
    ...
    internal sealed class MarshalPseudoCustomAttributeData : Cci.IMarshallingInformation
    {
        ...
        object Cci.IMarshallingInformation.GetCustomMarshaller(Microsoft.CodeAnalysis.Emit.EmitContext context)
        {
        ...
        Cci.ITypeReference Cci.IMarshallingInformation.GetSafeArrayElementUserDefinedSubtype(Microsoft.CodeAnalysis.Emit.EmitContext context)
        {
            Debug.Assert(_marshalType == Cci.Constants.UnmanagedType_SafeArray);

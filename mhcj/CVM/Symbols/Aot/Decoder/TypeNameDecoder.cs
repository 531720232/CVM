...
namespace Microsoft.CodeAnalysis
{
        ...
        where TypeSymbol : class
    {
        ...
        protected TypeSymbol GetCSArrayTypeSymbol(int rank, TypeSymbol elementType, ImmutableArray<ModifierInfo<TypeSymbol>> customModifiers)
        {
            return _factory.GetCSArrayTypeSymbol(this.moduleSymbol, rank, elementType, customModifiers);
        }

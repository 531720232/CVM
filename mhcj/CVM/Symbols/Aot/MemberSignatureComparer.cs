...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    /// </para>
    /// </summary>
    internal class MemberSignatureComparer2<T> : IEqualityComparer<T> where T:Symbol
    {
        /// <summary>
        ...
        /// </summary>
        public static readonly MemberSignatureComparer2<T> ExplicitImplementationComparer = new MemberSignatureComparer2<T>(
            considerName: false,
        ...
        /// </summary>
        public static readonly MemberSignatureComparer2<T> ExplicitImplementationLookupComparer = new MemberSignatureComparer2<T>(
            considerName: false,
            considerExplicitlyImplementedInterfaces: false,
            considerReturnType: true,
            considerTypeConstraints: false,
        ...
        /// </remarks>
        public static readonly MemberSignatureComparer2<T> CSharpImplicitImplementationComparer = new MemberSignatureComparer2<T>(
            considerName: true,
        ...
        /// as "close".
        /// </summary>
        public static readonly MemberSignatureComparer2<T> CSharpCloseImplicitImplementationComparer = new MemberSignatureComparer2<T>(
            considerName: true,
            considerExplicitlyImplementedInterfaces: true,
        ...
        /// </remarks>
        public static readonly MemberSignatureComparer2<T> DuplicateSourceComparer = new MemberSignatureComparer2<T>(
            considerName: true,
            considerExplicitlyImplementedInterfaces: true,
            considerReturnType: false,
            considerTypeConstraints: false,
        ...
        /// </summary>
        public static readonly MemberSignatureComparer2<T> PartialMethodsComparer = new MemberSignatureComparer2<T>(
            considerName: true,
            considerExplicitlyImplementedInterfaces: true,
            considerReturnType: false,
            considerTypeConstraints: false,
        ...
        /// </summary>
        public static readonly MemberSignatureComparer2<T> CSharpOverrideComparer = new MemberSignatureComparer2<T>(
            considerName: true,
            considerExplicitlyImplementedInterfaces: false,
            considerReturnType: false,
            considerTypeConstraints: false,
        ...
        /// </summary>
        public static readonly MemberSignatureComparer2<T> CSharpNullableOverrideComparer = new MemberSignatureComparer2<T>(
            considerName: true,
            considerExplicitlyImplementedInterfaces: false,
            considerReturnType: false,
            considerTypeConstraints: false,
        ...
        /// </summary>
        public static readonly MemberSignatureComparer2<T> CSharpWithTupleNamesComparer = new MemberSignatureComparer2<T>(
            considerName: true,
            considerExplicitlyImplementedInterfaces: false,
            considerReturnType: true,
            considerTypeConstraints: false,
        ...
        /// It is used to detect tuple-name-only differences.
        /// </summary>
        public static readonly MemberSignatureComparer2<T> CSharpWithoutTupleNamesComparer = new MemberSignatureComparer2<T>(
            considerName: true,
            considerExplicitlyImplementedInterfaces: false,
            considerReturnType: true,
            considerTypeConstraints: false,
        ...
        /// </summary>
        public static readonly MemberSignatureComparer2<T> CSharpAccessorOverrideComparer = new MemberSignatureComparer2<T>(
            considerName: false,
        ...
        /// </summary>
        public static readonly MemberSignatureComparer2<T> CSharpCustomModifierOverrideComparer = new MemberSignatureComparer2<T>(
            considerName: true,
            considerExplicitlyImplementedInterfaces: false,
            considerReturnType: true,
            considerTypeConstraints: false,
        ...
        /// </summary>
        public static readonly MemberSignatureComparer2<T> CSharpCustomModifierNullableOverrideComparer = new MemberSignatureComparer2<T>(
            considerName: true,
            considerExplicitlyImplementedInterfaces: false,
            considerReturnType: true,
            considerTypeConstraints: false,
        ...
        /// </summary>
        internal static readonly MemberSignatureComparer2<T> SloppyOverrideComparer = new MemberSignatureComparer2<T>(
            considerName: false,
            considerExplicitlyImplementedInterfaces: false,
            considerReturnType: false,
            considerTypeConstraints: false,
        ...
        /// </summary>
        public static readonly MemberSignatureComparer2<T> RuntimeSignatureComparer = new MemberSignatureComparer2<T>(
            considerName: true,
            considerExplicitlyImplementedInterfaces: false,
            considerReturnType: true,
            considerTypeConstraints: false,
        ...
        /// </summary>
        public static readonly MemberSignatureComparer2<T> RuntimePlusRefOutSignatureComparer = new MemberSignatureComparer2<T>(
            considerName: true,
            considerExplicitlyImplementedInterfaces: false,
            considerReturnType: true,
            considerTypeConstraints: false,
        ...
        /// </summary>
        public static readonly MemberSignatureComparer2<T> RuntimeImplicitImplementationComparer = new MemberSignatureComparer2<T>(
            considerName: true,
            considerExplicitlyImplementedInterfaces: true,
            considerReturnType: true,
            considerTypeConstraints: false, // constraints are checked by caller instead
        ...
        /// </summary>
        public static readonly MemberSignatureComparer2<T> CSharpSignatureAndConstraintsAndReturnTypeComparer = new MemberSignatureComparer2<T>(
            considerName: true,
            considerExplicitlyImplementedInterfaces: true,
            considerReturnType: true,
        ...
        /// </summary>
        public static readonly MemberSignatureComparer2<T> RetargetedExplicitImplementationComparer = new MemberSignatureComparer2<T>(
            considerName: true,
        ...
        /// </summary>
        public static readonly MemberSignatureComparer2<T> CrefComparer = new MemberSignatureComparer2<T>(
        ...
        private MemberSignatureComparer2(
            bool considerName,
        ...
        private static Cci.CallingConvention GetCallingConvention(Symbol member)
        {
            switch (member.Kind)
            {
                ...
                case SymbolKind.Event:
                    return member.IsStatic ? 0 : Cci.CallingConvention.ThisCall;
                default:
        ...
        ///
        /// </summary>
        internal static bool ConsideringTupleNamesCreatesDifference(T member1, T member2)
        {
            var w = MemberSignatureComparer2<T>.CSharpWithTupleNamesComparer;
           
            return !w.Equals(member1, member2) &&
                w.Equals(member1, member2);
        }
    }
}

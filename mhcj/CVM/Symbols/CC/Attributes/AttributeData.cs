...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal abstract partial class CSharpAttributeData : AttributeData
    {
        ...
        internal bool IsSecurityAttribute(CVM_Zone compilation)
        {
        ...
        internal void DecodeSecurityAttribute<T>(Symbol targetSymbol, CVM_Zone compilation, ref DecodeWellKnownAttributeArguments<AttributeSyntax, CSharpAttributeData, AttributeLocation> arguments)
        ...
        private DeclarativeSecurityAction DecodeSecurityAttributeAction(Symbol targetSymbol, CVM_Zone compilation, AttributeSyntax nodeOpt, out bool hasErrors, DiagnosticBag diagnostics)
        {
        ...
        private string DecodePermissionSetAttribute(CVM_Zone compilation, AttributeSyntax nodeOpt, DiagnosticBag diagnostics)
        {
            Debug.Assert(!this.HasErrors);
            ...
            if (namedArgs.Length == 1)
            {
                    ...
                    PermissionSetAttributeTypeHasRequiredProperty(attrType, filePropName))
                {
                    ...
                    //var resolver = compilation.XmlReferenceResolver;

...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal static class ConstraintsHelper
    {
        ...
        {
            public readonly CVM_Zone CurrentCompilation;
            public readonly ConversionsBase Conversions;
            public readonly Location Location;
            public readonly DiagnosticBag Diagnostics;

            public CheckConstraintsArgs(CVM_Zone currentCompilation, ConversionsBase conversions, Location location, DiagnosticBag diagnostics)
            {
        ...
        private static bool HasDuplicateInterfaces(NamedTypeSymbol type, ConsList<Symbol> basesBeingResolved)
        {
            ...
            return type.InterfacesNoUseSiteDiagnostics(basesBeingResolved).HasDuplicates((IEqualityComparer<NamedTypeSymbol>)TypeSymbol.EqualsIgnoringDynamicTupleNamesAndNullabilityComparer);
        }

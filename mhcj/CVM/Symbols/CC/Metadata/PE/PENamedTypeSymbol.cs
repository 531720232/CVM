...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE
{
    ...
    internal abstract class PENamedTypeSymbol : NamedTypeSymbol
    {
        ...
        private static void GetGenericInfo(PEModuleSymbol moduleSymbol, TypeDefinition handle, out GenericParameterHandleCollection genericParameterHandles, out ushort arity, out BadImageFormatException mrEx)
        {
            try
            {

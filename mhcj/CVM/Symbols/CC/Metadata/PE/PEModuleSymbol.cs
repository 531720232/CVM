...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Metadata.PE
{
    ...
    internal sealed class PEModuleSymbol : NonMissingModuleSymbol
    {
        ...
        /// </summary>
        private readonly CVM_Zone _module;
        ...
        /// </summary>
        internal readonly ConcurrentDictionary<TypeDefinition, TypeSymbol> TypeHandleToTypeMap =
                                    new ConcurrentDictionary<TypeDefinition, TypeSymbol>(concurrencyLevel: 2, capacity: DefaultTypeMapCapacity);
        ...
        /// </summary>
        internal readonly ConcurrentDictionary<TypeReference, TypeSymbol> TypeRefHandleToTypeMap =
                                    new ConcurrentDictionary<TypeReference, TypeSymbol>(concurrencyLevel: 2, capacity: DefaultTypeMapCapacity);
        ...
        internal PEModuleSymbol(PEAssemblySymbol assemblySymbol, CVM_Zone module, MetadataImportOptions importOptions, int ordinal)
            : this((AssemblySymbol)assemblySymbol, module, importOptions, ordinal)
        {
            Debug.Assert(ordinal >= 0);
        }

        internal PEModuleSymbol(SourceAssemblySymbol assemblySymbol, CVM_Zone module, MetadataImportOptions importOptions, int ordinal)
            : this((AssemblySymbol)assemblySymbol, module, importOptions, ordinal)
        {
            Debug.Assert(ordinal > 0);
        }

        internal PEModuleSymbol(RetargetingAssemblySymbol assemblySymbol, CVM_Zone module, MetadataImportOptions importOptions, int ordinal)
            : this((AssemblySymbol)assemblySymbol, module, importOptions, ordinal)
        {
            Debug.Assert(ordinal > 0);
        }

        private PEModuleSymbol(AssemblySymbol assemblySymbol, CVM_Zone module, MetadataImportOptions importOptions, int ordinal)
        {

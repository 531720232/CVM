...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed class SymbolDistinguisher
    {
        ...
        public SymbolDistinguisher(CVM_Zone compilation, Symbol symbol0, Symbol symbol1)
        {
        ...
        private static string GetLocationString(CVM_Zone compilation, Symbol unwrappedSymbol)
        {
            ...
            if (syntaxReferences.Length > 0)
            {
                ...
                string path = "___";// tree.GetDisplayPath(span, (compilation != null) ? compilation.SourceReferenceResolver : null);

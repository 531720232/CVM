...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal sealed class ExtendedErrorTypeSymbol : ErrorTypeSymbol
    {
        ...
        internal ExtendedErrorTypeSymbol(CVM_Zone compilation, string name, int arity, DiagnosticInfo errorInfo, bool unreported = false, bool variableUsedBeforeDeclaration = false)

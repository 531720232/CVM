...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.Retargeting
{
    ...
    internal partial class RetargetingModuleSymbol
    {
            ...
            : CSharpSymbolVisitor<RetargetOptions, Symbol>
        {
            ...
            {
                return (NamespaceSymbol)this.SymbolMap.GetOrAdd(ns, (x) => { return _retargetingModule._createRetargetingNamespace.Invoke(x); });
            }
            ...
            private NamedTypeSymbol RetargetNamedTypeDefinitionFromUnderlyingAssembly(NamedTypeSymbol type)
            {
                ...
                if (ReferenceEquals(module, this.UnderlyingModule))
                {
                    ...
                    return (NamedTypeSymbol)this.SymbolMap.GetOrAdd(type,(x)=> { return _retargetingModule._createRetargetingNamedType.Invoke(x); });
                }
                else
                {
                    return default;
            ...
            private NamedTypeSymbol RetargetNoPiaLocalType(NamedTypeSymbol type)
            {
                ...
                NamedTypeSymbol result = default ;
            ...
            {
                return (TypeParameterSymbol)this.SymbolMap.GetOrAdd(typeParameter,(x)=> { return _retargetingModule._createRetargetingTypeParameter.Invoke(x); });
            }
            ...
            public MethodSymbol Retarget(MethodSymbol method)
            {
                ...
                return (MethodSymbol)this.SymbolMap.GetOrAdd(method,(x)=> { return _retargetingModule._createRetargetingMethod.Invoke(x); });
            }
            ...
            {
                return (FieldSymbol)this.SymbolMap.GetOrAdd(field, (x) => { return _retargetingModule._createRetargetingField.Invoke(x); });
            }
            ...
            public PropertySymbol Retarget(PropertySymbol property)
            {
                ...
                return (PropertySymbol)this.SymbolMap.GetOrAdd(property, (x) => { return _retargetingModule._createRetargetingProperty.Invoke(x); });
            }
            ...
            public EventSymbol Retarget(EventSymbol @event)
            {
                ...
                {
                    return (EventSymbol)this.SymbolMap.GetOrAdd(@event, (x) => { return _retargetingModule._createRetargetingEvent.Invoke(x); });
                }

...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal static partial class TypeSymbolExtensions
    {
        ...
        /// <returns></returns>
        public static bool IsValidAttributeParameterType(this TypeSymbol type, CVM_Zone compilation)
        {
        ...
        public static TypedConstantKind GetAttributeParameterTypedConstantKind(this TypeSymbol type, CVM_Zone compilation)
        {
            // Spec (17.1.3)
...
#pragma warning restore CA1200 // Avoid using cref tags with a prefix
        ...
        internal static bool IsNonGenericTaskType(this TypeSymbol type, CVM_Zone compilation)
        {
            var namedType = type as NamedTypeSymbol;
        ...
        internal static bool IsGenericTaskType(this TypeSymbol type, CVM_Zone compilation)
        {
            var namedType = type as NamedTypeSymbol;
        ...
        internal static bool IsIAsyncEnumerableType(this TypeSymbol type, CVM_Zone compilation)
        {
            var namedType = type as NamedTypeSymbol;
            if ((object)namedType == null || namedType.Arity != 1)
            {
        ...
        /// </summary>
        internal static TypeSymbol NormalizeTaskTypes(this TypeSymbol type, CVM_Zone compilation)
        {
        ...
        /// </summary>
        private static bool NormalizeTaskTypesInType(CVM_Zone compilation, ref TypeSymbol type)
        {
            switch (type.Kind)
            {
                case SymbolKind.NamedType:
        ...
        private static bool NormalizeTaskTypesInType(CVM_Zone compilation, ref TypeSymbolWithAnnotations typeWithAnnotations)
        {
        ...
        private static bool NormalizeTaskTypesInNamedType(CVM_Zone compilation, ref NamedTypeSymbol type)
        {
        ...
        private static bool NormalizeTaskTypesInTuple(CVM_Zone compilation, ref NamedTypeSymbol type)
        {
        ...
        private static bool NormalizeTaskTypesInArray(CVM_Zone compilation, ref ArrayTypeSymbol arrayType)
        {
        ...
        private static bool NormalizeTaskTypesInPointer(CVM_Zone compilation, ref PointerTypeSymbol pointerType)
        {
        ...
        public static bool IsBadAsyncReturn(this TypeSymbol returnType, CVM_Zone declaringCompilation)
        {

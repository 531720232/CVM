...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal abstract class ModuleSymbol : Symbol, IModuleSymbol
    {
        ...
        internal bool HasDynamicAttribute(object target, out ImmutableArray<bool> dynamicTransformFlags)
        {
            throw new NotImplementedException();
        }

        internal bool HasTupleElementNamesAttribute(object targetHandle, out ImmutableArray<string> elementNames)
        {
            throw new NotImplementedException();
        }

...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal struct LexicalSortKey
    {
        ...
        private LexicalSortKey(SyntaxTree tree, int position, CVM_Zone compilation)
            : this(tree == null ? -1 : compilation.GetSyntaxTreeOrdinal(tree), position)
        {
        }

        public LexicalSortKey(SyntaxReference syntaxRef, CVM_Zone compilation)
        ...
        public LexicalSortKey(Location location, CVM_Zone compilation)
        ...
        public LexicalSortKey(CSharpSyntaxNode node, CVM_Zone compilation)
        ...
        // if the node is stored in the constructor of the symbol. In particular, do not call this on the result of a GetSyntax()
        // call on a SyntaxReference.
        public LexicalSortKey(SyntaxToken token, CVM_Zone compilation)

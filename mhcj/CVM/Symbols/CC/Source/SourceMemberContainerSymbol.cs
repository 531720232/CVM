...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal abstract partial class SourceMemberContainerTypeSymbol : NamedTypeSymbol
    {
        ...
        private static readonly Dictionary<string, ImmutableArray<NamedTypeSymbol>> s_emptyTypeMembers = new Dictionary<string, ImmutableArray<NamedTypeSymbol>>((IEqualityComparer<string>)EmptyComparer2.Instance);
...
//..    DeclaringCompilation.SymbolDeclaredEvent(this);
        ...
        private Dictionary<string, ImmutableArray<NamedTypeSymbol>> MakeTypeMembers(DiagnosticBag diagnostics)
        {
            ...
            var conflictDict = new Dictionary<CVM.Tuple2<string, int>, SourceNamedTypeSymbol>();
            try
            {
                foreach (var childDeclaration in declaration.Children)
                {
                    ...
                    var key =new CVM.Tuple2<string,int>(t.Name, t.Arity);
        ...
        private void CheckFiniteFlatteningGraph(DiagnosticBag diagnostics)
        {
            ...
            var instanceMap = new Dictionary<NamedTypeSymbol, NamedTypeSymbol>((IEqualityComparer<NamedTypeSymbol>)ReferenceEqualityComparer.Instance);
            ...
            DiagnosticBag diagnostics)
        {
            ...
            var methodsBySignature = new Dictionary<MethodSymbol, SourceMemberMethodSymbol>(MemberSignatureComparer2<MethodSymbol>.PartialMethodsComparer);

...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal sealed partial class SourceAssemblySymbol : MetadataOrSourceAssemblySymbol, ISourceAssemblySymbolInternal, IAttributeTargetSymbol
    {
        ...
        /// </summary>
        internal  ImmutableArray<ModuleSymbol> _modules=new ImmutableArray<ModuleSymbol>(new ModuleSymbol[0] { });
           ...
           )
        {
            ...
            Debug.Assert(!CVM.AHelper.IsNullOrWhiteSpace(moduleName));
            //Debug.Assert(!netModules.IsDefault);

            _compilation = compilation;
            _assemblySimpleName = assemblySimpleName;

            ArrayBuilder<ModuleSymbol> moduleBuilder = new ArrayBuilder<ModuleSymbol>(1);
        ...
        /// </remarks>
        internal sealed override CVM_Zone DeclaringCompilation
        {
            get
            {
                return _compilation;
        ...
        internal bool MightContainNoPiaLocalTypes()
        {
            ...
            //{
            //    var peModuleSymbol = _modules[i];
            //    if (peModuleSymbol.ContainsNoPiaLocalTypes())
            //    {
            //        return true;
            //    }
            //}
        ...
        private void ValidateAttributeSemantics(DiagnosticBag diagnostics)
        {
            ...
            //if (StrongNameKeys.DiagnosticOpt != null && !_compilation.OutputKind.IsNetModule())
            //{
            ...
            //{
            //    if (_compilation.OutputKind.IsNetModule())
            //    {
            ...
            //if (DeclaringCompilation.OutputKind != OutputKind.NetModule &&
        ...
        /// </remarks>
        private static void ReportDiagnosticsForSynthesizedAttributes(CVM_Zone compilation, DiagnosticBag diagnostics)
        {
            ReportDiagnosticsForUnsafeSynthesizedAttributes(compilation, diagnostics);

            var compilationOptions = compilation;
        ...
        /// the attribute CONSTRUCTORS have errors.
        /// </remarks>
        private static void ReportDiagnosticsForUnsafeSynthesizedAttributes(CVM_Zone compilation, DiagnosticBag diagnostics)
        {
            var compilationOptions = compilation;
        ...
        private void LoadAndValidateNetModuleAttributes(ref CustomAttributesBag<CSharpAttributeData> lazyNetModuleAttributesBag)
        {
            if (_compilation.OutputKind.IsNetModule())
            {
                CVM.AHelper.CompareExchange(ref lazyNetModuleAttributesBag, CustomAttributesBag<CSharpAttributeData>.Empty, null);
            }
            else
            {
                var diagnostics = DiagnosticBag.GetInstance();
        ...
        internal override void AddSynthesizedAttributes(PEModuleBuilder moduleBuilder, ref ArrayBuilder<SynthesizedAttributeData> attributes)
        {
            ...
            if (_compilation.OutputKind == OutputKind.NetModule)
            {
        ...
        internal override IEnumerable<ImmutableArray<byte>> GetInternalsVisibleToPublicKeys(string simpleName)
        {
            ...
            ConcurrentDictionary<ImmutableArray<byte>, Tuple2<Location, string>> result = null;
        ...
        private AssemblyIdentity ComputeIdentity()
        {
            return new AssemblyIdentity(
                _assemblySimpleName,
                VersionHelper.GenerateVersionFromPatternAndCurrentTime(_compilation.CurrentLocalTime, AssemblyVersionAttributeSetting),
        ...
        private ConcurrentDictionary<string, ConcurrentDictionary<ImmutableArray<byte>, Tuple2<Location, string>>> _lazyInternalsVisibleToMap;
        ...
        private void DecodeOneInternalsVisibleToAttribute(
            ...
            DiagnosticBag diagnostics,
            int index,
            ref ConcurrentDictionary<string, ConcurrentDictionary<ImmutableArray<byte>,CVM.Tuple2<Location, string>>> lazyInternalsVisibleToMap)
        {
            // this code won't be called unless we bound a well-formed, semantically correct ctor call.
            ...
            Tuple2<Location, string> locationAndValue = null;
            ...
            {
                locationAndValue = new Tuple2<Location, string>(GetAssemblyAttributeLocationForDiagnostic(nodeOpt), displayName);
            }
            ...
            //contents eventually.
            ConcurrentDictionary<ImmutableArray<byte>, Tuple2<Location, string>> keys = null;
            ...
            {
                keys = new ConcurrentDictionary<ImmutableArray<byte>, Tuple2<Location, String>>();
                keys.TryAdd(identity.PublicKey, locationAndValue);
        ...
        private void DecodeWellKnownAttribute(ref DecodeWellKnownAttributeArguments<AttributeSyntax, CSharpAttributeData, AttributeLocation> arguments, int index, bool isFromNetModule)
        {
            ...
            else if (attribute.IsTargetAttribute(this, AttributeDescription.AssemblyCultureAttribute))
            {
                ...
                {
                    if (_compilation.OutputKind.IsApplication())
                    {
            ...
            //    arguments.GetOrCreateData<CommonAssemblyWellKnownAttributeData>().A.AssemblyAlgorithmIdAttributeSetting = algorithmId;
            //}
        }
        ...
        internal override NamedTypeSymbol TryLookupForwardedMetadataTypeWithCycleDetection(ref MetadataTypeName emittedName, ConsList<AssemblySymbol> visitedAssemblies)
        {
            ...
            //else if (!_compilation.OutputKind.IsNetModule())
            //{
        ...
        CVM_Zone ISourceAssemblySymbol.Compilation => _compilation;
    }
}

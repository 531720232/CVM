...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal abstract class SourceMemberMethodSymbol : SourceMethodSymbol, IAttributeTargetSymbol
    {
        ...
        internal sealed override Cci.CallingConvention CallingConvention
        {
            get
            {
                // var cc = IsVararg ? Cci.CallingConvention.ExtraArguments : Cci.CallingConvention.n;
                var cc = Cci.CallingConvention.Standard;
                if (IsGenericMethod)
                {
              //      cc |= Cci.CallingConvention...Generic;
                ...
                if (!IsStatic)
                {
                    cc |= Cci.CallingConvention.ThisCall;
                }
        ...
        internal CVM.Tuple2<BlockSyntax, ArrowExpressionClauseSyntax> Bodies
        {
            get
            {
                switch (SyntaxNode)
                {
                    case BaseMethodDeclarationSyntax method:
                        return new Tuple2<BlockSyntax, ArrowExpressionClauseSyntax>(method.Body, method.ExpressionBody);

                    case AccessorDeclarationSyntax accessor:
                        return new Tuple2<BlockSyntax, ArrowExpressionClauseSyntax>(accessor.Body, accessor.ExpressionBody);
                    ...
                    case ArrowExpressionClauseSyntax arrowExpression:
                        ...
                        return new Tuple2<BlockSyntax, ArrowExpressionClauseSyntax> (null, arrowExpression);

                    case BlockSyntax block:
                        Debug.Assert(this is SynthesizedClosureMethod);
                        return new Tuple2<BlockSyntax, ArrowExpressionClauseSyntax>(block, null);

                    default:
                        return new Tuple2<BlockSyntax, ArrowExpressionClauseSyntax>(null, null);
                }
            }
        }
        ...
        private CustomAttributesBag<CSharpAttributeData> GetAttributesBag(ref CustomAttributesBag<CSharpAttributeData> lazyCustomAttributesBag, bool forReturnType)
        {
            ...
            if ((object)copyFrom != null)
            {
                ...
                bagCreatedOnThisThread =CVM.AHelper.CompareExchange(ref lazyCustomAttributesBag, attributesBag, null) == null;
            }
        ...
        internal override int CalculateLocalSyntaxOffset(int localPosition, SyntaxTree localTree)
        {
            ...
            var blockBody = Bodies.Item1;
            var expressionBody = Bodies.Item2;

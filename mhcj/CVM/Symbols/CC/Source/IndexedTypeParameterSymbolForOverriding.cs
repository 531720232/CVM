...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    {
        private static TypeParameterSymbol[] s_parameterPoolHasValueTypeConstraint = new TypeParameterSymbol[0];
        private static TypeParameterSymbol[] s_parameterPoolHasNoValueTypeConstraint = new TypeParameterSymbol[0];

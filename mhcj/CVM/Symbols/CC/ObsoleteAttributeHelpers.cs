...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal static class ObsoleteAttributeHelpers
    {
        ...
        /// </summary>
        internal static void InitializeObsoleteDataFromMetadata(ref ObsoleteAttributeData data, System.Reflection.MemberInfo token, AotModuleSymbol containingModule, bool ignoreByRefLikeMarker)
        {
            ...
            if (ReferenceEquals(data, ObsoleteAttributeData.Uninitialized))
            {
                ...
                CVM.AHelper.CompareExchange(ref data, obsoleteAttributeData, ObsoleteAttributeData.Uninitialized);
            }
        }
        /// <summary>
        ...
        /// done for Metadata symbol easily whereas trying to do this for source symbols could result in cycles.
        /// </summary>
        internal static ObsoleteAttributeData GetObsoleteDataFromMetadata(System.Reflection.MemberInfo token, AotModuleSymbol containingModule, bool ignoreByRefLikeMarker)
        {
            ObsoleteAttributeData obsoleteAttributeData=default;
           var objs= token.GetCustomAttributes(typeof(System.ObsoleteAttribute), false);

            foreach(var o in objs)
            {
                if(o is System.ObsoleteAttribute attr)
                {
                    obsoleteAttributeData = new ObsoleteAttributeData(ObsoleteAttributeKind.Obsolete, attr.Message, attr.IsError);
                    break;
                }
            }

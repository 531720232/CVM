...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal class SynthesizedEmbeddedAttributeSymbol : NamedTypeSymbol
    {
        ...
        public SynthesizedEmbeddedAttributeSymbol(
            ...
            Func<CVM_Zone, NamedTypeSymbol, DiagnosticBag, ImmutableArray<MethodSymbol>> getConstructors,
        ...
        private static NamedTypeSymbol MakeBaseType(CVM_Zone compilation, DiagnosticBag diagnostics)
        {

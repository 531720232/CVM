    ...
    internal sealed partial class AnonymousTypeManager
    {
        ...
        private ConcurrentDictionary<string, AnonymousTypeTemplateSymbol> AnonymousTypeTemplates
        {
            get
            {
                ...
                {
                    //CVM_Zone previousSubmission = this.Compilation.PreviousSubmission;
        ...
        /// </summary>
        public void AssignTemplatesNamesAndCompile(MethodCompiler compiler, Emit.PEModuleBuilder moduleBeingBuilt, DiagnosticBag diagnostics)
        {
        ...
        internal IDictionary<Microsoft.CodeAnalysis.Emit.AnonymousTypeKey, Microsoft.CodeAnalysis.Emit.AnonymousTypeValue> GetAnonymousTypeMap()
        {
        ...
        private sealed class AnonymousTypeComparer : IComparer<AnonymousTypeTemplateSymbol>
        {
            ...
            public AnonymousTypeComparer(CVM_Zone compilation)
            {

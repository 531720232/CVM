...
namespace Microsoft.CodeAnalysis
{
    internal struct AttributeUsageInfo : IEquatable<AttributeUsageInfo>
    {
            ...
            public string ToString(string format, IFormatProvider formatProvider)
            {
                ...
                if (_targetResourceIds != null)
                {
                    foreach (string id in _targetResourceIds)
                    {
                        ...
                        builder.Builder.Append(id);// CodeAnalysisResources.ResourceManager.GetString(id, culture));
                    }
                }
        ...
        private static string GetErrorDisplayNameResourceId(AttributeTargets target)
        {
            switch (target)
            {
                //case AttributeTargets.Assembly: return nameof(AttributeTargets.Assembly);
                //case AttributeTargets.Class: return nameof(AttributeTargets.Class);
                //case AttributeTargets.Constructor: return nameof(AttributeTargets.Constructor);

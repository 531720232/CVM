...
namespace Microsoft.CodeAnalysis
{
    ...
    public sealed class DllImportData : Cci.IPlatformInvokeInformation
    {
        ...
        private readonly Mono.Cecil.MethodImplAttributes _flags;

        internal DllImportData(string moduleName, string entryPointName, Mono.Cecil.MethodImplAttributes flags)
        {
        ...
        Mono.Cecil.MethodImplAttributes Cci.IPlatformInvokeInformation.Flags
        {
            get { return _flags; }
        }
        ...
        public bool ExactSpelling
        {
            get
            {
                return (_flags & Mono.Cecil.MethodImplAttributes..ExactSpelling) != 0;
            }
        }

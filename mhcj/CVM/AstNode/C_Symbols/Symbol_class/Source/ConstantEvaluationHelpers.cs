...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal static class ConstantEvaluationHelpers
    {
            ...
            Dictionary<SourceFieldSymbolWithSyntaxReference, Node<SourceFieldSymbolWithSyntaxReference>> graph)
        {
            ...
            var compilations = PooledDictionary<CSharp.CVM_Zone, int>.GetInstance();
        ...
        private static void OrderCompilations(
            ...
            Dictionary<CVM_Zone, int> compilations)
        {
        ...
        {
            private readonly Dictionary<CVM_Zone, int> _compilationOrdering;

            internal SourceLocationComparer(Dictionary<CVM_Zone, int> compilationOrdering)
            {

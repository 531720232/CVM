...
namespace Microsoft.CodeAnalysis
{
    ...
    //    WindowsRuntime = 1
            ...
            int contentType =0)
        {
            ...
            if (isRetargetable && contentType == 1)
            {
                throw new ArgumentException(nameof(isRetargetable));
            }
           ...
           int contentType = 0)
        {
            ...
            _version = version ?? NullVersion;
            _cultureName = NormalizeCultureName(cultureName);
            _contentType = IsValid(contentType) ? contentType :0;
            _isRetargetable = isRetargetable && _contentType !=1;
            InitializeKey(publicKeyOrToken, hasPublicKey, out _publicKey, out _lazyPublicKeyToken);
        }

...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed partial class BoundLambda : IBoundLambdaOrFunction
    {
        ...
        /// </summary>
        internal static InferredLambdaReturnType InferReturnType(ArrayBuilder<CVM.Tuple2<RefKind, TypeSymbolWithAnnotations>> returnTypes, CSharpCompilation compilation, ConversionsBase conversions, TypeSymbol delegateType, bool isAsync)
        {
        ...
        internal sealed class BlockReturns : BoundTreeWalker
        {
            ...
            public override BoundNode VisitReturnStatement(BoundReturnStatement node)
            {
                ...
                _builder.Add(new CVM.Tuple2<CodeAnalysis.RefKind, TypeSymbolWithAnnotations>(node.RefKind, TypeSymbolWithAnnotations.Create(type)));
                return null;
            }
        }
    }

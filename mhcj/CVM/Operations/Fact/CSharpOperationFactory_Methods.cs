...
namespace Microsoft.CodeAnalysis.Operations
{
    internal sealed partial class CSharpOperationFactory
    {
        ...
        private Lazy1<IOperation> CreateReceiverOperation(BoundNode instance, ISymbol symbol)
        {
            ...
            return new Lazy1<IOperation>(() => Create(instance));
        }
        ...
        private IEventReferenceOperation CreateBoundEventAccessOperation(BoundEventAssignmentOperator boundEventAssignmentOperator)
        {
            ...
            Lazy1<IOperation> instance = CreateReceiverOperation(boundEventAssignmentOperator.ReceiverOpt, @event);

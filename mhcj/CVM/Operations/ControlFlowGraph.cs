...
namespace Microsoft.CodeAnalysis.FlowAnalysis
{
    ...
    public sealed partial class ControlFlowGraph
    {
        ...
        private readonly ImmutableDictionary<IMethodSymbol, CVM.Tuple2<ControlFlowRegion, ILocalFunctionOperation, int>> _localFunctionsMap;
        private ControlFlowGraph[] _lazyLocalFunctionsGraphs;
        private readonly ImmutableDictionary<IFlowAnonymousFunctionOperation, CVM.Tuple2<ControlFlowRegion, int>> _anonymousFunctionsMap;
        ...
        internal ControlFlowGraph(IOperation originalOperation,
                                  ...
                                  ImmutableDictionary<IMethodSymbol, CVM.Tuple2<ControlFlowRegion,ILocalFunctionOperation, int>> localFunctionsMap,
                                  ImmutableDictionary<IFlowAnonymousFunctionOperation, CVM.Tuple2<ControlFlowRegion, int>> anonymousFunctionsMap)
        {
...
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
        ...
        {
            if (!_localFunctionsMap.TryGetValue(localFunction, out CVM.Tuple2<ControlFlowRegion , ILocalFunctionOperation , int > info))
            {
                controlFlowGraph = null;
                return false;
            }

            Debug.Assert(localFunction == LocalFunctions[info.Item3]);
        ...
        {
            if (!_anonymousFunctionsMap.TryGetValue(anonymousFunction, out  Tuple2<ControlFlowRegion, int> info))
            {
                controlFlowGraph = null;
                return false;
            }

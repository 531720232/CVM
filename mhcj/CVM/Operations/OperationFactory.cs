...
namespace Microsoft.CodeAnalysis.Operations
{
    internal static class OperationFactory
    {
        ...
        public static Lazy1<IOperation> NullOperation { get; } = new Lazy1<IOperation>(() => null);
        public static Lazy1<IVariableInitializerOperation> NullInitializer { get; } = new Lazy1<IVariableInitializerOperation>(() => null);
    }
}

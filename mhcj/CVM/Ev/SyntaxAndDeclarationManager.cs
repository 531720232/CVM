...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed partial class SyntaxAndDeclarationManager : CommonSyntaxAndDeclarationManager
    {
        ...
        internal State GetLazyState()
        {
            if (_lazyState == null)
            {
                CVM.AHelper.CompareExchange(ref _lazyState, CreateState(this.ExternalSyntaxTrees, this.ScriptClassName, this.Resolver, this.MessageProvider, this.IsSubmission), null);
            }
            ...
            bool isSubmission)
        {
            ...
            var declMapBuilder = PooledDictionary<SyntaxTree, Lazy1<RootSingleNamespaceDeclaration>>.GetInstance();
        ...
        private static void AppendAllSyntaxTrees(
            ...
            IDictionary<SyntaxTree, Lazy1<RootSingleNamespaceDeclaration>> declMapBuilder,
        ...
        private static void AddSyntaxTreeToDeclarationMapAndTable(
            ...
            ref DeclarationTable declTable)
        {
            var lazyRoot = new Lazy1<RootSingleNamespaceDeclaration>(() => DeclarationTreeBuilder.ForTree(tree, scriptClassName, isSubmission));
        ...
        private static void RemoveSyntaxTreeFromDeclarationMapAndTable(
            SyntaxTree tree,
            IDictionary<SyntaxTree, Lazy1<RootSingleNamespaceDeclaration>> declMap,
            ref DeclarationTable declTable)
        {

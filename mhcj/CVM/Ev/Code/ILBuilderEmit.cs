...
namespace Microsoft.CodeAnalysis.CodeGen
{
    internal partial class ILBuilder
    {
        ...
        //    PooledInstrBuilder.GetInstance().PeekPush(Cci.MetadataWriter.LiteralGreatestMethodDefinitionToken);
        }
       ...
       //     PooledInstrBuilder.GetInstance().PeekPush(Cci.MetadataWriter.ModuleVersionIdStringToken);
        }

...
namespace Microsoft.CodeAnalysis.CodeGen
{
    ...
    {
        private readonly int _optimizations;
        ...
        internal ImmutableArray<Instruction> RealizedIL;
        ...
        internal ILBuilder(ITokenDeferral module, LocalSlotManager localSlotManager, int optimizations)
        {
        ...
        private void RealizeBlocks()
        {
            ...
            if (_optimizations == 1 && OptimizeLabels())
            {

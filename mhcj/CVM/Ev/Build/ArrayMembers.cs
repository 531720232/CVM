...
namespace Microsoft.CodeAnalysis.CodeGen
{
    ...
    internal class ArrayMethods
    {
        ...
        /// </summary>
        private readonly ConcurrentDictionary<CVM.Tuple2<byte , Cci.IArrayTypeReference >, ArrayMethod> _dict =
            new ConcurrentDictionary<CVM.Tuple2<byte, Cci.IArrayTypeReference>, ArrayMethod>();
        ...
        {
            var key = new CVM.Tuple2<byte, Cci.IArrayTypeReference>((byte)id, arrayType);
            ArrayMethod result;
    ...
    internal abstract class ArrayMethod : Cci.IMethodReference
    {
        ...
        public Cci.CallingConvention CallingConvention => Cci.CallingConvention.ThisCall;

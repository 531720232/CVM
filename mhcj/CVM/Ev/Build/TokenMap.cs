...
namespace Microsoft.CodeAnalysis.CodeGen
{
    ...
    {
        private readonly ConcurrentDictionary<T, uint> _itemIdentityToToken = new ConcurrentDictionary<T, uint>();//((IEqualityComparer<T>)ReferenceEqualityComparer.Instance);

...
namespace Microsoft.CodeAnalysis.CSharp.CodeGen
{
    ...
    internal sealed class StackOptimizerPass1 : BoundTreeRewriter
    {
        ...
        private readonly ArrayBuilder<CVM.Tuple2<BoundExpression, ExprContext>> _evalStack;
        ...
        private StackOptimizerPass1(Dictionary<LocalSymbol, LocalDefUseInfo> locals,
            ArrayBuilder<CVM.Tuple2<BoundExpression, ExprContext>> evalStack,
            bool debugFriendly)
        {
            _locals = locals;
        ...
        public static BoundNode Analyze(
            ...
            bool debugFriendly)
        {
            var evalStack = ArrayBuilder<CVM.Tuple2<BoundExpression, ExprContext>>.GetInstance();
        ...
        private void PushEvalStack(BoundExpression result, ExprContext context)
        {
            ...
            _evalStack.Add(new CVM.Tuple2<BoundExpression, ExprContext>(result, context));
        }

...
namespace Microsoft.CodeAnalysis.CodeGen
{
    ...
    {
        private readonly ConcurrentDictionary<T, uint> _itemToToken = new ConcurrentDictionary<T, uint>();//((IEqualityComparer<T>)ReferenceEqualityComparer.Instance);

        ...
        Cci.IMethodDefinition
    {
        ...
        Cci.ISpecializedMethodReference Cci.IMethodReference.AsSpecializedMethodReference
        {
            get
            {
                ...
                if (!this.IsDefinition &&
                    (!this.IsGenericMethod || CVM_Zone.IsGenericType(this.ContainingType)))
                {
                    Debug.Assert((object)this.ContainingType != null &&
                            CVM_Zone.IsGenericType(this.ContainingType));
                    return this;
                }
        ...
        void Cci.IReference.Dispatch(Cci.MetadataVisitor visitor)
        {
            ...
            {
                var moduleBeingBuilt =(PEModuleBuilder)visitor.Context.Module;
        ...
        Cci.IMethodReference Cci.IGenericMethodInstanceReference.GetGenericMethod(EmitContext context)
        {
            ...
            if (!CVM_Zone.IsGenericType(container))
            {
        ...
        Cci.TypeMemberVisibility Cci.ITypeDefinitionMember.Visibility
        {
            ...
            {
                CheckDefinitionInvariant();
                return CVM_Zone.MemberVisibility(this);
            }
        }
        ...
        {
            CheckDefinitionInvariant();
            return (context.Module).GetMethodBody(this);
        }
        ...
        IEnumerable<Cci.ICustomAttribute> Cci.IMethodDefinition.GetReturnValueAttributes(EmitContext context)
        {
            ...
            return GetCustomAttributesToEmit(userDefined, synthesized, isReturnType: true, emittingAssemblyAttributesInNetModule: false).AsEnumerable().ToArray();
        }

...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal partial class Symbol : Cci.IReference
    {
        ...
        {
            return GetCustomAttributesToEmit((PEModuleBuilder)context.Module).ToImmutableArray().array;
        }
        ...
        internal IEnumerable<CSharpAttributeData> GetCustomAttributesToEmit(CSharp.Emit.PEModuleBuilder moduleBuilder, bool emittingAssemblyAttributesInNetModule)
        {
            CheckDefinitionInvariant();
            Debug.Assert(this.Kind != SymbolKind.Assembly);

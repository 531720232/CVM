...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    internal static partial class TypeSymbolExtensions
    {
        ...
        /// <returns></returns>
        internal static TypeSymbol GetNextBaseTypeNoUseSiteDiagnostics(this TypeSymbol type, ConsList<Symbol> basesBeingResolved, CVM_Zone compilation, ref PooledHashSet<NamedTypeSymbol> visited)
        {
        ...
        private static TypeSymbol GetNextDeclaredBase(NamedTypeSymbol type, ConsList<Symbol> basesBeingResolved, CVM_Zone compilation, ref PooledHashSet<NamedTypeSymbol> visited)
        {
        ...
        private static NamedTypeSymbol GetDefaultBaseOrNull(NamedTypeSymbol type, CVM_Zone compilation)
        {
            if (compilation == null)
            {
                return null;

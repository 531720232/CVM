...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal abstract class StateMachineRewriter
    {
        ...
        protected IDictionary<Symbol, CapturedSymbolReplacement> nonReusableLocalProxies;
        protected int nextFreeHoistedLocalSlot;
        protected HashSet<Symbol> hoistedVariables;
        ...
        private void CreateNonReusableLocalProxies(
            ...
            out IDictionary<Symbol, CapturedSymbolReplacement> proxies,
            out int nextFreeHoistedLocalSlot)
        {
            ...
            bool isDebugBuild = F.Compilation.OptimizationLevel == 0;
        ...
        {
            var synthesizedKind = local.SynthesizedKind;
            var optimizationLevel = F.Compilation.OptimizationLevel;
            ...
            if (optimizationLevel ==1 && synthesizedKind == SynthesizedLocalKind.UserDefined)
            {
                return false;
            }

            return !synthesizedKind.IsSlotReusable(optimizationLevel==0);
        }

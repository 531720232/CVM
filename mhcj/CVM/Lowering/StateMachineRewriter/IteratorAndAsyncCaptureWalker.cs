...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed class IteratorAndAsyncCaptureWalker : DataFlowPass
    {
        ...
        private IteratorAndAsyncCaptureWalker(CVM_Zone compilation, MethodSymbol method, BoundNode node, NeverEmptyStructTypeCache emptyStructCache, HashSet<Symbol> initiallyAssignedVariables)
            : base(compilation,
                  method,
                  node,
                  emptyStructCache,
        ...
        public static OrderedSet<Symbol> Analyze(CVM_Zone compilation, MethodSymbol method, BoundNode node, DiagnosticBag diagnostics)
        {
            ...
            if (compilation.OptimizationLevel !=1)
            {
        ...
        private void CaptureVariable(Symbol variable, SyntaxNode syntax)
        {
            ...
            else if (compilation.OptimizationLevel == 1)
            {

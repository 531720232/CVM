...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed class AsyncMethodToStateMachineRewriter : MethodToStateMachineRewriter
    {
        ...
        private FieldSymbol GetAwaiterField(TypeSymbol awaiterType)
        {
            ...
            {
                int slotIndex;
                if (slotAllocatorOpt == null || !slotAllocatorOpt.TryGetPreviousAwaiterSlotIndex(F.Compilation.Translate(awaiterType, F.Syntax, F.Diagnostics), F.Diagnostics, out slotIndex))
                {

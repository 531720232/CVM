...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed class DynamicAnalysisInjector : CompoundInstrumenter
    {
        ...
        private readonly SequencePointList.DebugDocumentProvider _debugDocumentProvider;
        ...
        public static DynamicAnalysisInjector TryCreate(
            ...
            SequencePointList.DebugDocumentProvider debugDocumentProvider,
        ...
        private static MethodSymbol GetCreatePayloadOverload(CVM_Zone compilation, WellKnownMember overload, SyntaxNode syntax, DiagnosticBag diagnostics)
        {

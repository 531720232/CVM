...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed partial class DiagnosticsPass
    {
        ...
        public static void IssueDiagnostics(CVM_Zone compilation, BoundNode node, DiagnosticBag diagnostics, MethodSymbol containingSymbol)
        {
        ...
        private DiagnosticsPass(CVM_Zone compilation, DiagnosticBag diagnostics, MethodSymbol containingSymbol)
        {

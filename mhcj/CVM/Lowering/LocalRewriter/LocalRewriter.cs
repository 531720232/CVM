...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed partial class LocalRewriter : BoundTreeRewriterWithStackGuard
    {
        ...
        private CVM_Zone EmitModule
        {
            get { return _factory.CompilationState.Compilation; }
        }
        ...
        public override BoundNode VisitLocalFunctionStatement(BoundLocalFunctionStatement node)
        {
            ...
            {
                _factory.CompilationState.Compilation?.EnsureNullableAttributeExists();
            }
        ...
        /// <summary>
        /// This function provides a false sense of security, it is likely going to surprise you when the requested member is missing.
        /// Recommendation: Do not use, use <see cref="TryGetSpecialTypeMethod(SyntaxNode, SpecialMember, CVM_Zone, DiagnosticBag, out MethodSymbol)"/> instead!
        /// If used, a unit-test with a missing member is absolutely a must have.
        /// </summary>
        private static MethodSymbol UnsafeGetSpecialTypeMethod(SyntaxNode syntax, SpecialMember specialMember, CVM_Zone compilation, DiagnosticBag diagnostics)
        {
            MethodSymbol method;
        ...
        private static bool TryGetSpecialTypeMethod(SyntaxNode syntax, SpecialMember specialMember, CVM_Zone compilation, DiagnosticBag diagnostics, out MethodSymbol method)
        {
        ...
        public override BoundNode VisitTypeOrInstanceInitializers(BoundTypeOrInstanceInitializers node)
        {
            ...
            bool optimize = _compilation.OptimizationLevel == 1;
        ...
        private void CheckRefReadOnlySymbols(MethodSymbol symbol)
        {
            ...
            {
                _factory.CompilationState.Compilation?.EnsureIsReadOnlyAttributeExists();
            }
        }

    ...
    internal class ConcurrentQueue<T> : IEnumerable<T>, ICollection,IEnumerable
    {
     ...
     public   bool TryAdd(T item)
        ...
        private List<T> ToList()
        {
            ...
            AHelper.Increment(ref _numSnapshotTakers);
            ...
            finally
            {
                ...
                AHelper.Decrement(ref _numSnapshotTakers);
            }
            return list;
        }
        ...
        private class Segment
        {
            ...
            internal bool TryAppend(T value)
            {
                ...
                {
                    newhigh = CVM.AHelper.Increment(ref _high);
            ...
            internal bool TryRemove(out T result)
            {
                ...
                {
                    //try to update _low
                    if (AHelper.CompareExchange(ref _low, lowLocal + 1, lowLocal) == lowLocal)
                    {

...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal sealed partial class DeclarationTable
    {
        ...
        private readonly Lazy1<RootSingleNamespaceDeclaration> _latestLazyRootDeclaration;
        ...
        private readonly Lazy1<ICollection<string>> _typeNames;
        private readonly Lazy1<ICollection<string>> _namespaceNames;
        private readonly Lazy1<ICollection<ReferenceDirective>> _referenceDirectives;

        private DeclarationTable(
            ImmutableSetWithInsertionOrder<RootSingleNamespaceDeclaration> allOlderRootDeclarations,
            Lazy1<RootSingleNamespaceDeclaration> latestLazyRootDeclaration,
            Cache cache)
        {
            ...
            _typeNames = new Lazy1<ICollection<string>>(GetMergedTypeNames);
            _namespaceNames = new Lazy1<ICollection<string>>(GetMergedNamespaceNames);
            _referenceDirectives = new Lazy1<ICollection<ReferenceDirective>>(GetMergedReferenceDirectives);
        }

        public DeclarationTable AddRootDeclaration(Lazy1<RootSingleNamespaceDeclaration> lazyRootDeclaration)
        {
        ...
        public DeclarationTable RemoveRootDeclaration(Lazy1<RootSingleNamespaceDeclaration> lazyRootDeclaration)
        {
        ...
        public MergedNamespaceDeclaration GetMergedRoot(CVM_Zone compilation)
        {
        ...
        internal MergedNamespaceDeclaration CalculateMergedRoot(CVM_Zone compilation)
        {
        ...
        private sealed class RootNamespaceLocationComparer : IComparer<SingleNamespaceDeclaration>
        {
            ...
            internal RootNamespaceLocationComparer(object compilation)
            {
        ...
        private static HashSet<string> GetTypeNames(Declaration declaration)
        {
            return GetNames(declaration, s_isTypePredicate);
        }

        private static HashSet<string> GetNamespaceNames(Declaration declaration)
        {
            return GetNames(declaration, s_isNamespacePredicate);
        }

        private static HashSet<string> GetNames(Declaration declaration, Predicate<Declaration> predicate)
        {

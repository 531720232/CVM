...
namespace Microsoft.CodeAnalysis.Text
{
    ...
    /// </summary>
    public abstract class TextLineCollection : IList<TextLine>
    {
        /// <summary>
        ...
        /// </summary>
        public abstract TextLine this[int index] { get;set; }
        ...
        int IList<TextLine>.IndexOf(TextLine item)
        {
            throw new NotImplementedException();
        }

        void IList<TextLine>.Insert(int index, TextLine item)
        {
            throw new NotImplementedException();
        }

        void IList<TextLine>.RemoveAt(int index)
        {
            throw new NotImplementedException();
        }

        void ICollection<TextLine>.Add(TextLine item)
        {
            throw new NotImplementedException();
        }

        void ICollection<TextLine>.Clear()
        {
            throw new NotImplementedException();
        }

        bool ICollection<TextLine>.Contains(TextLine item)
        {
            throw new NotImplementedException();
        }

        void ICollection<TextLine>.CopyTo(TextLine[] array, int arrayIndex)
        {
            throw new NotImplementedException();
        }

        bool ICollection<TextLine>.Remove(TextLine item)
        {
            throw new NotImplementedException();
        }

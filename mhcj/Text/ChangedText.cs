...
namespace Microsoft.CodeAnalysis.Text
{
    public class WeakReference<T>
    {
        ...
        {
            target = item;
            System.GC.SuppressFinalize(target);
    ...
    internal sealed class ChangedText : SourceText
    {
            ...
            : base(checksumAlgorithm: oldText.ChecksumAlgorithm)
        {
            ...
            _newText = newText;
            var ow = (oldText as ChangedText);

            _info = new ChangeInfo(changeRanges, new WeakReference<SourceText>(oldText), ow != null?_info:null);
        }

        private class ChangeInfo
        {
            private ImmutableArray<TextChangeRange> _ChangeRanges;
            ...
            private WeakReference<SourceText> _weak;
        ...
        public override IList<TextChangeRange> GetChangeRanges(SourceText oldText)
        {
            if (oldText == null)
            {
        ...
        private static IList<ImmutableArray<TextChangeRange>> GetChangesBetween(SourceText oldText, ChangedText newText)
        {
        ...
        private static ImmutableArray<TextChangeRange> Merge(IList<ImmutableArray<TextChangeRange>> changeSets)
        {

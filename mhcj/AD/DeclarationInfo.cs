...
namespace Microsoft.CodeAnalysis
{
    ...
    internal struct DeclarationInfo
    {
        ...
        private readonly object _declaredSymbol;

        internal DeclarationInfo(SyntaxNode declaredNode, ImmutableArray<SyntaxNode> executableCodeBlocks, object declaredSymbol)
        {
        ...
        /// </summary>
        public object DeclaredSymbol => _declaredSymbol;
    }
}

...
namespace System
{
    public partial class OperationCanceledException : System.SystemException
    {
        ...
        public OperationCanceledException(string message, CVM.CancellationToken token) { }
        public OperationCanceledException(CVM.CancellationToken token) { }
        ...
        public CVM.CancellationToken CancellationToken { get { throw null; } }
    }
}

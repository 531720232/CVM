...
namespace Microsoft.CodeAnalysis
{
    ...
    public static class CaseInsensitiveComparison
    {
        ...
        public static bool Equals(string left, string right) { return s_comparer.Equals(left, right);
        }
        /// <summary>
        ...
        /// <returns></returns>
        public static bool EndsWith(string value, string possibleEnd) { return OneToOneUnicodeComparer.EndsWith(value, possibleEnd);
        }
        /// <summary>
        ...
        /// <returns></returns>
        public static bool StartsWith(string value, string possibleStart) { return OneToOneUnicodeComparer.StartsWith(value, possibleStart);
        }
        /// <summary>

...
namespace Roslyn.Utilities
{
    internal static partial class SpecializedCollections
    {
        ...
        public static IList<T> EmptyOnlyList<T>()
        {
            return Empty.List<T>.Instance;
        }
        ...
        public static ISet<T> EmptyReadOnlySet<T>()
        {
            return Empty.Set<T>.Instance;
        }
        ...
        public static IDictionary<TKey, TValue> EmptyReadOnlyDictionary<TKey, TValue>()
        {
            return Empty.Dictionary<TKey, TValue>.Instance;
        }
        ...
        public static ISet<T> StronglyTypedReadOnlySet<T>(ISet<T> set)
        {
            return set == null || set.Count == 0
                ? EmptyReadOnlySet<T>()
                : new ReadOnly.Set<ISet<T>, T>(set);

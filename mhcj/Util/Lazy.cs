...
internal enum LazyState
    ...
    internal class LazyHelper
    {
        ...
        internal LazyState State { get; private set; }
    ...
    public class Lazy1<T>
    {
        ...
        /// An instance created with this constructor may be used concurrently from multiple threads.
        /// </remarks>
        public Lazy1(Func<T> valueFactory)
        ...
        /// </param>
        public Lazy1(bool isThreadSafe) :
        ...
        public Lazy1(LazyThreadSafetyMode mode) :
        ...
        public Lazy1(Func<T> valueFactory, bool isThreadSafe) :
        ...
        public Lazy1(Func<T> valueFactory, LazyThreadSafetyMode mode)
            : this(valueFactory, mode, useDefaultConstructor: false)
        {
        }

        private Lazy1(Func<T> valueFactory, LazyThreadSafetyMode mode, bool useDefaultConstructor)
        {
            if (valueFactory == null && !useDefaultConstructor)
                throw new ArgumentNullException((valueFactory).ToString());
        ...
        {
            LazyHelper previous = CVM.AHelper.CompareExchange(ref _state, LazyHelper.PublicationOnlyWaitForOtherThreadToPublish, publicationOnly);
        ...
        {
            return IsValueCreated ? Value.ToString() : "";
        }
        ...
        /// </summary>
        internal bool IsValueFaulted { get { return LazyHelper.GetIsValueFaulted(_state); } }
        ...
        /// </remarks>
        public bool IsValueCreated { get { return _state == null; } }
        ...
        public T Value
        {
            get { return _state == null ? _value : CreateValue(); }
        }
        ...
        internal sealed class LazyDebugView<T>
        {
            ...
            private readonly Lazy1<T> _lazy;
            ...
            public LazyDebugView(Lazy1<T> lazy)
            {
                _lazy = lazy;
            }

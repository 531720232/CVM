...
namespace CVM.Linq
{
    internal static partial class EnumerableExtensions
    {
        ...
        public static ICollection<T> ToSet<T>(this IEnumerable<T> source, IEqualityComparer<T> comparer)
        {
            if (source == null)
            {
                throw new ArgumentNullException();
        ...
        public static ICollection<T> ToSet<T>(this IEnumerable<T> source)
        {
            if (source == null)
            {
                throw new ArgumentNullException();
            ...
            return source as ICollection<T> ?? new HashSet<T>(source);
        }
            ...
            where T : class
        {
            ...
            Func<T, bool> func = new Func<T, bool>((x) => {

             return   s_notNullTest.Invoke(x);
            });
        ...
        {
            return source.OrderBy(CVM_Comparer<T>.Create(compare));
        }
        ...
        {
            return source.ThenBy(CVM_Comparer<T>.Create(compare));
        }
        ...
        private static class Comparisons<T> where T : IComparable<T>
        {
            ...
            public static readonly IComparer<T> Comparer = CVM_Comparer<T>.Create(CompareTo);
        }
        ...
        public static IComparer<T> ToComparer<T>(this Comparison<T> comparison)
        {
            ...
            return CVM_Comparer<T>.Create(comparison);
        }
    }

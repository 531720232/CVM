...
namespace Roslyn.Utilities
{
    ...
    internal sealed class ConcurrentSet<T> : ICollection<T>
    {
        ...
        /// </summary>
        private readonly Dictionary<T, byte> _dictionary;
        ...
        {
            _dictionary = new Dictionary<T, byte>(DefaultCapacity);
        }
        ...
        {
            _dictionary = new Dictionary<T, byte>(DefaultCapacity, equalityComparer);
        }

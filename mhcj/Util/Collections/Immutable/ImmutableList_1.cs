...
namespace CVM.Collections.Immutable
{
    /// <summary>
    ...
    public sealed partial class ImmutableList<T> : IImmutableList<T>, IList<T>, IList, IOrderedCollection<T>, IImmutableListQueries<T>, IStrongEnumerable<T, ImmutableList<T>.Enumerator>
    {
        ...
        /// </summary>
        public ImmutableList<T> Clear() { return Empty;
        }
        /// <summary>
        ...
        /// or the <see cref="IComparable"/> interface for type <typeparamref name="T"/>.
        /// </exception>
        public int BinarySearch(int index, int count, T item, IComparer<T> comparer) { return _root.BinarySearch(index, count, item, comparer);
        }
        ...
        /// See the <see cref="IImmutableList{T}"/> interface.
        /// </summary>
        IImmutableList<T> IImmutableList<T>.Clear() { return this.Clear();
        }
        /// <summary>
        /// See the <see cref="IImmutableList{T}"/> interface.
        /// </summary>
...
#else
        public T this[int index] { get { return _root[index]; } }
#endif
        ...
        /// </summary>
        T IOrderedCollection<T>.this[int index] { get { return this[index]; } }
        ...
        {
            Requires.Range(index >= 0 && index <= this.Count, "");
        ...
        public ImmutableList<T> Remove(T value) { return this.Remove(value, EqualityComparer<T>.Default);
        }
        /// <summary>
        /// See the <see cref="IImmutableList{T}"/> interface.
        /// </summary>
        ...
        {
            Requires.Range(index >= 0 && index <= this.Count, "");
            Requires.Range(count >= 0 && index + count <= this.Count, "");
        ...
        public ImmutableList<T> RemoveRange(IEnumerable<T> items) { return this.RemoveRange(items, EqualityComparer<T>.Default);
        }
        /// <summary>
        /// Removes the specified values from this list.
        /// </summary>
        ...
        public ImmutableList<T> SetItem(int index, T value) { return this.Wrap(_root.ReplaceAt(index, value));
        }
        /// <summary>
        /// See the <see cref="IImmutableList{T}"/> interface.
        /// </summary>

        public ImmutableList<T> Replace(T oldValue, T newValue) { return this.Replace(oldValue, newValue, EqualityComparer<T>.Default);
        }
        /// <summary>
        /// See the <see cref="IImmutableList{T}"/> interface.
        /// </summary>
        ...
        public ImmutableList<T> Reverse() { return this.Wrap(_root.Reverse());
        }
        /// <summary>
        ...
        public ImmutableList<T> Reverse(int index, int count) { return this.Wrap(_root.Reverse(index, count));
        }
        /// <summary>
        ...
        public ImmutableList<T> Sort() { return this.Wrap(_root.Sort());
        }
        /// <summary>
        /// Sorts the elements in the entire <see cref="ImmutableList{T}"/> using
        ...
        public ImmutableList<T> Sort(IComparer<T> comparer) { return this.Wrap(_root.Sort(comparer));
        }
        /// <summary>
        ...
        {
            Requires.Range(index >= 0, "");
            Requires.Range(count >= 0, "");
            Requires.Range(index + count <= this.Count, "");
        ...
        /// false.
        /// </returns>
        public bool Exists(Predicate<T> match) { return _root.Exists(match);
        }
        /// <summary>
        ...
        /// </returns>
        public T Find(Predicate<T> match) { return _root.Find(match);
        }
        /// <summary>
        ...
        /// </returns>
        public ImmutableList<T> FindAll(Predicate<T> match) { return _root.FindAll(match);
        }
        /// <summary>
        /// Searches for an element that matches the conditions defined by the specified
        ...
        /// </returns>
        public int FindIndex(Predicate<T> match) { return _root.FindIndex(match);
        }
        /// <summary>
        /// Searches for an element that matches the conditions defined by the specified
        /// predicate, and returns the zero-based index of the first occurrence within
        ...
        /// conditions defined by <paramref name="match"/>, if found; otherwise, -1.
        /// </returns>
        public int FindIndex(int startIndex, Predicate<T> match) { return _root.FindIndex(startIndex, match);
        }
        /// <summary>
        /// Searches for an element that matches the conditions defined by the specified
        /// predicate, and returns the zero-based index of the first occurrence within
        ...
        /// conditions defined by <paramref name="match"/>, if found; otherwise, -1.
        /// </returns>
        public int FindIndex(int startIndex, int count, Predicate<T> match) { return _root.FindIndex(startIndex, count, match);
        }
        /// <summary>
        /// Searches for an element that matches the conditions defined by the specified
        ...
        /// if found; otherwise, the default value for type <typeparamref name="T"/>.
        /// </returns>
        public T FindLast(Predicate<T> match) { return _root.FindLast(match);
        }
        /// <summary>
        /// Searches for an element that matches the conditions defined by the specified
        ...
        /// conditions defined by <paramref name="match"/>, if found; otherwise, -1.
        /// </returns>
        public int FindLastIndex(Predicate<T> match) { return _root.FindLastIndex(match);
        }
        /// <summary>
        /// Searches for an element that matches the conditions defined by the specified
        /// predicate, and returns the zero-based index of the last occurrence within
        ...
        /// conditions defined by <paramref name="match"/>, if found; otherwise, -1.
        /// </returns>
        public int FindLastIndex(int startIndex, Predicate<T> match) { return _root.FindLastIndex(startIndex, match);
        }
        /// <summary>
        /// Searches for an element that matches the conditions defined by the specified
        /// predicate, and returns the zero-based index of the last occurrence within
        ...
        /// conditions defined by <paramref name="match"/>, if found; otherwise, -1.
        /// </returns>
        public int FindLastIndex(int startIndex, int count, Predicate<T> match) { return _root.FindLastIndex(startIndex, count, match);
        }
        /// <summary>
        ...
        public int IndexOf(T item, int index, int count, IEqualityComparer<T> equalityComparer) { return _root.IndexOf(item, index, count, equalityComparer);
        }
        /// <summary>
        /// Searches for the specified object and returns the zero-based index of the
        ...
        public int LastIndexOf(T item, int index, int count, IEqualityComparer<T> equalityComparer) { return _root.LastIndexOf(item, index, count, equalityComparer);
        }
        /// <summary>
        ...
        /// See the <see cref="IImmutableList{T}"/> interface.
        /// </summary>
        public bool Contains(T value) { return this.IndexOf(value) >= 0;
        }
        /// <summary>
        /// See the <see cref="IImmutableList{T}"/> interface.
        /// </summary>
        public int IndexOf(T value) { return this.IndexOf(value, EqualityComparer<T>.Default);
        }
        /// <summary>
        /// See the <see cref="IImmutableList{T}"/> interface.
        /// </summary>

        IImmutableList<T> IImmutableList<T>.Add(T value) {return this.Add(value);
    }
        /// <summary>
        /// See the <see cref="IImmutableList{T}"/> interface.
        /// </summary>

        IImmutableList<T> IImmutableList<T>.AddRange(IEnumerable<T> items) { return this.AddRange(items);
        }
        /// <summary>
        ...
        IImmutableList<T> IImmutableList<T>.Insert(int index, T item) { return this.Insert(index, item);
        }
        /// <summary>
        /// Inserts the specified value at the specified index.
        /// </summary>
        ...
        IImmutableList<T> IImmutableList<T>.Remove(T value, IEqualityComparer<T> equalityComparer) { return this.Remove(value, equalityComparer);
        }
        /// <summary>
        /// See the <see cref="IImmutableList{T}"/> interface.
        /// </summary>

        IImmutableList<T> IImmutableList<T>.RemoveAll(Predicate<T> match) { return this.RemoveAll(match);
        }
        /// <summary>
        /// See the <see cref="IImmutableList{T}"/> interface.
        /// </summary>

        IImmutableList<T> IImmutableList<T>.RemoveRange(IEnumerable<T> items, IEqualityComparer<T> equalityComparer) { return this.RemoveRange(items, equalityComparer);
        }
        /// <summary>
        /// See the <see cref="IImmutableList{T}"/> interface.
        /// </summary>

        IImmutableList<T> IImmutableList<T>.RemoveRange(int index, int count) { return this.RemoveRange(index, count);
        }
        /// <summary>
        ...
        IImmutableList<T> IImmutableList<T>.RemoveAt(int index) { return this.RemoveAt(index);
        }
        /// <summary>
        ...
        IImmutableList<T> IImmutableList<T>.SetItem(int index, T value) { return this.SetItem(index, value);
        }
        /// <summary>
        ...
        IImmutableList<T> IImmutableList<T>.Replace(T oldValue, T newValue, IEqualityComparer<T> equalityComparer) {return this.Replace(oldValue, newValue, equalityComparer);
        }
        #endregion
        ...
        /// </returns>
        bool IList.Contains(object value) { return IsCompatibleObject(value) && this.Contains((T)value);
        }
        /// <summary>
        ...
        /// </returns>
        int IList.IndexOf(object value) { return IsCompatibleObject(value) ? this.IndexOf((T)value) : -1;
        }
        /// <summary>
        ...
        /// </remarks>
        public Enumerator GetEnumerator() { return new Enumerator(_root);
        }
        /// <summary>

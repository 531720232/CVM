...
namespace CVM.Collections.Immutable
{
    ...
    public static class ImmutableList
    {
        ...
        public static ImmutableList<T> Create<T>() { return ImmutableList<T>.Empty; }
        ...
        public static ImmutableList<T> Create<T>(T item) { return ImmutableList<T>.Empty.Add(item); }
        ...
        public static ImmutableList<T> CreateRange<T>(IEnumerable<T> items) { return ImmutableList<T>.Empty.AddRange(items); }
        ...
        public static ImmutableList<T> Create<T>(params T[] items) {return ImmutableList<T>.Empty.AddRange(items); }
        ...
        public static ImmutableList<T>.Builder CreateBuilder<T>() { return Create<T>().ToBuilder(); }

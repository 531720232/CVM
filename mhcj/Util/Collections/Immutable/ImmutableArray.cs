...
namespace CVM.Collections.Immutable
{
    ...
    public static class ImmutableArray
    {
        ...
        {
            Requires.NotNull(items, (items).ToString());
            Requires.Range(start >= 0 && start <= items.Length, (start).ToString());
            Requires.Range(length >= 0 && start + length <= items.Length, (length).ToString());
        ...
        {
            Requires.NotNull(selector, (selector).ToString());
        ...
        public static ImmutableArray<TResult> CreateRange<TSource, TResult>(ImmutableArray<TSource> items, int start, int length, Func<TSource, TResult> selector)
        {
            ...
            Requires.Range(start >= 0 && start <= itemsLength, (start).ToString());
            Requires.Range(length >= 0 && start + length <= itemsLength, (length).ToString());
            Requires.NotNull(selector, (selector).ToString());
        ...
        {
            Requires.NotNull(builder, (builder).ToString());

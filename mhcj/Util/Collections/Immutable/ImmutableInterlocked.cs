    ...
    public static class ImmutableInterlocked
    {
        ...
        public static bool Update<T>(ref T location, Func<T, T> transformer) where T : class
        {
            ...
            do
            {
                ...
                T interlockedResult = AHelper.CompareExchange(ref location, newValue, oldValue);
        ...
        public static bool Update<T, TArg>(ref T location, Func<T, TArg, T> transformer, TArg transformerArgument) where T : class
        {
            ...
            bool successful;
            T oldValue = location;// Volatile.Read(ref location);
            do
            {
        ...
        {
            return new ImmutableArray<T>(AHelper.Exchange(ref location.array, value.array));
        }
        ...
        {
            return new ImmutableArray<T>(AHelper.CompareExchange(ref location.array, value.array, comparand.array));
        }
        ...
        public static TValue GetOrAdd<TKey, TValue>(ref ImmutableDictionary<TKey, TValue> location, TKey key, TValue value)
        {
            ...
            do
            {
                Requires.NotNull(priorCollection, "");
                TValue oldValue;
                ...
                var interlockedResult = AHelper.CompareExchange(ref location, updatedCollection, priorCollection);
        ...
        {
            Requires.NotNull(addValueFactory, "");

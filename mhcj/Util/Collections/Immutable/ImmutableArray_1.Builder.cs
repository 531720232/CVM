...
namespace CVM.Collections.Immutable
{
    public partial struct ImmutableArray<T>
    {
        ...
        public sealed class Builder : IList<T>, IReadOnlyList<T>
        {
            ...
            {
                Requires.Range(capacity >= 0, (capacity).ToString());
            ...
            public int Count
            {
                ...
                set
                {
                    Requires.Range(value >= 0, (value).ToString());
                    if (value < _count)
                    {
                        // truncation mode
            ...
            {
                Requires.Range(index >= 0 && index <= this.Count, (index).ToString());
            ...
            {
                Requires.NotNull(items, (items).ToString());
            ...
            {
                Requires.NotNull(items, (items).ToString());
                Requires.Range(length >= 0 && length <= items.Length, (length).ToString());
            ...
            {
                Requires.Range(length >= 0, (length).ToString());
            ...
            {
                Requires.NotNull(array, (array).ToString());
                Requires.Range(index >= 0 && index + this.Count <= array.Length, (index).ToString());
            ...
            public int IndexOf(T item, int startIndex, int count, IEqualityComparer<T> equalityComparer)
            {
                ...
                Requires.Range(startIndex >= 0 && startIndex < this.Count, (startIndex).ToString());
                Requires.Range(count >= 0 && startIndex + count <= this.Count, (count).ToString());
            ...
            public int LastIndexOf(T item, int startIndex, int count, IEqualityComparer<T> equalityComparer)
            {
                ...
                Requires.Range(startIndex >= 0 && startIndex < this.Count, (startIndex).ToString());
                Requires.Range(count >= 0 && startIndex - count + 1 >= 0, (count).ToString());
            ...
            {
                Requires.NotNull(comparison, (comparison).ToString());
                ...
                if (Count > 1)
                {
                    ...
                    Array.Sort(_elements, 0, _count, CVM_Comparer<T>.Create(comparison));
                }
            }
            ...
            public void Sort(int index, int count, IComparer<T> comparer)
            {
                ...
                Requires.Range(index >= 0, (index).ToString());
                Requires.Range(count >= 0 && index + count <= this.Count, (count).ToString());

...
namespace CVM.Collections.Immutable
{
    ...
    public sealed partial class ImmutableList<T>
    {
        ...
        public sealed class Builder : IList<T>, IList, IOrderedCollection<T>, IImmutableListQueries<T>, IReadOnlyList<T>
        {
            ...
            public int IndexOf(T item, int index) { return
            ...
            public int IndexOf(T item, int index, int count) { return
            ...
            /// </returns>
            public bool TrueForAll(Predicate<T> match) { return _root.TrueForAll(match); }
            ...
            object ICollection.SyncRoot
            {
                get
                {
                    if (_syncRoot == null)
                    {
                       AHelper.CompareExchange<Object>(ref _syncRoot, new object(), null);
                    }

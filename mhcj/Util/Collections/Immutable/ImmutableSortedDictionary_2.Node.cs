...
namespace CVM.Collections.Immutable
{
    public sealed partial class ImmutableSortedDictionary<TKey, TValue>
    {
        ...
        internal sealed class Node : IBinaryTree<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>
        {
            ...
            {
                get { return System.Linq.Enumerable.Select(this, p => p.Key); }
            }
            ...
            {
                get { return System.Linq.Enumerable.Select(this, p => p.Value); }
            }
            ...
            internal void CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex, int dictionarySize)
            {
                ...
                Requires.Range(array.Length >= arrayIndex + dictionarySize, "");
            ...
            {
                Requires.NotNullAllowStructs(key, "");
                Requires.NotNull(keyComparer, "");
                Requires.NotNull(valueComparer, "");
            ...
            {
                Requires.NotNullAllowStructs(equalKey, "");
                Requires.NotNull(keyComparer, "");
            ...
            {
                Requires.NotNullAllowStructs(pair.Key, "");
                Requires.NotNull(keyComparer, "");
                Requires.NotNull(valueComparer, "");

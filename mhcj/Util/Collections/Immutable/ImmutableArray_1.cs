...
{
    public partial struct ImmutableArray<T> : IReadOnlyList<T>, IList<T>, IEquatable<ImmutableArray<T>>, IList, IImmutableArray, IImmutableList<T>
    {
        /// <summary>
        ...
        public int IndexOf(T item, int startIndex, int count, IEqualityComparer<T> equalityComparer)
        {
            ...
            Requires.Range(startIndex >= 0 && startIndex < self.Length, (startIndex).ToString());
            Requires.Range(count >= 0 && startIndex + count <= self.Length, (count).ToString());
        ...
        public int LastIndexOf(T item, int startIndex, int count, IEqualityComparer<T> equalityComparer)
        {
            ...
            Requires.Range(startIndex >= 0 && startIndex < self.Length,"");
            Requires.Range(count >= 0 && startIndex - count + 1 >= 0, "");
        ...
        public ImmutableArray<T> RemoveRange(int index, int length)
        {
            ...
            self.ThrowNullRefIfNotInitialized();
            Requires.Range(index >= 0 && index <= self.Length, "");
            Requires.Range(length >= 0 && index + length <= self.Length, "");
        ...
        public ImmutableArray<T> Sort(Comparison<T> comparison)
        {
            ...
            var self = this;
            return self.Sort(CVM_Comparer<T>.Create(comparison));
        }
        ...
        public ImmutableArray<T> Sort(int index, int count, IComparer<T> comparer)
        {
            ...
            Requires.Range(count >= 0 && index + count <= self.Length, "");
      ...
      public     int GetHashCode(IEqualityComparer comparer)
        {
            var self = this;
            var ours = self.array;
            return ours != null ? ours.GetHashCode() : self.GetHashCode();
        }
        ...
        private ImmutableArray<T> RemoveAtRange(ICollection<int> indicesToRemove)
        {
            var self = this;
            self.ThrowNullRefIfNotInitialized();
            Requires.NotNull(indicesToRemove, "");

...
{
    public  partial struct SeparatedSyntaxList<TNode> : IEquatable<SeparatedSyntaxList<TNode>>, IList<TNode> where TNode : SyntaxNode
    {
        ...
        int ICollection<TNode>.Count => this.Count;

        bool ICollection<TNode>.IsReadOnly => throw new NotImplementedException();

        TNode IList<TNode>.this[int index] { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }

    ...
    public abstract partial class SyntaxNode
    {
        ...
        internal SyntaxNode GetRed(ref SyntaxNode field, int slot)
        {
            ...
            if (result == null)
            {
                ...
                if (green != null)
                {
                    CVM.AHelper.CompareExchange(ref field, green.CreateRed(this, this.GetChildPosition(slot)), null);
                    result = field;
                }
            }
        ...
        internal SyntaxNode GetRedAtZero(ref SyntaxNode field)
        {
            ...
            if (result == null)
            {
                ...
                if (green != null)
                {
                    CVM.AHelper.CompareExchange(ref field, green.CreateRed(this, this.Position), null);
                    result = field;
                }
            }
        ...
        protected T GetRed<T>(ref T field, int slot) where T : SyntaxNode
        {
            ...
            if (result == null)
            {
                ...
                if (green != null)
                {
                    CVM.AHelper.CompareExchange(ref field, (T)green.CreateRed(this, this.GetChildPosition(slot)), null);
                    result = field;
                }
            }
        ...
        protected T GetRedAtZero<T>(ref T field) where T : SyntaxNode
        {
            ...
            if (result == null)
            {
                ...
                if (green != null)
                {
                    CVM.AHelper.CompareExchange(ref field, (T)green.CreateRed(this, this.Position), null);
                    result = field;
                }
            }
        ...
        internal SyntaxNode GetRedElement(ref SyntaxNode element, int slot)
        {
            ...
            if (result == null)
            {
                ...
                CVM.AHelper.CompareExchange(ref element, green.CreateRed(this.Parent, this.GetChildPosition(slot)), null);
                result = element;
            }
        ...
        internal SyntaxNode GetRedElementIfNotToken(ref SyntaxNode element)
        {
            ...
            if (result == null)
            {
                ...
                {
                    // passing list's parent
                    CVM.AHelper.CompareExchange(ref element, green.CreateRed(this.Parent, this.GetChildPosition(1)), null);
                    result = element;
                }
            }

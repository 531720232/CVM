...
namespace Microsoft.CodeAnalysis
{
    ...
    internal abstract class GreenNode : IObjectWritable
    {
        ...
        private static readonly Dictionary<GreenNode, DiagnosticInfo[]> s_diagnosticsTable =
            new Dictionary<GreenNode, DiagnosticInfo[]>();

        private static readonly Dictionary<GreenNode, SyntaxAnnotation[]> s_annotationsTable =
            new Dictionary<GreenNode, SyntaxAnnotation[]>();
        ...
        public IEnumerable<SyntaxAnnotation> GetAnnotations(string annotationKind)
        {
            ...
            if (annotationKind.IsNullOrWhiteSpace())
            {
        ...
        protected internal void WriteTo(TextWriter writer, bool leading, bool trailing)
        {
            ...
            var stack = new Stack<Node_Lead_Tr>();
            stack.Push(new Node_Lead_Tr(this, leading, trailing));
        ...
        public class Node_Lead_Tr
        {
            public GreenNode node;
            public bool leading;
            public bool trailing;
            public Node_Lead_Tr(GreenNode node,bool lead,bool trail)
            {
                this.node = node;
                leading = lead;
                trailing = trail;
            ...
            while (stack.Count > 0)
            {
                ...
                for (var i = lastIndex; i >= firstIndex; i--)
                {
                    ...
                    if (child != null)
                    {
                        ...
                        stack.Push(new Node_Lead_Tr(child, currentLeading | !first, currentTrailing | !last));
                    }
                }
            }
        }

...
namespace Microsoft.CodeAnalysis
{
    ...
    {
        private static readonly Dictionary<SyntaxNode, SyntaxAnnotation> s_nodeToIdMap
            = new Dictionary<SyntaxNode, SyntaxAnnotation>();

        private static readonly Dictionary<SyntaxNode, CurrentNodes> s_rootToCurrentNodesMap
            = new Dictionary<SyntaxNode, CurrentNodes>();

...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    public abstract partial class CSharpSyntaxTree : SyntaxTree
    {
        ...
        /// </summary>
        private ImmutableArray<int> _preprocessorStateChangePositions=new ImmutableArray<int>();

        /// <summary>
        /// Preprocessor states corresponding to positions in <see cref="_preprocessorStateChangePositions"/>.
        /// </summary>
        private ImmutableArray<InternalSyntax.DirectiveStack> _preprocessorStates=new ImmutableArray<InternalSyntax.DirectiveStack>();
        ...
        private void BuildPreprocessorStateChangeMap()
        {
            ...
            CVM.AHelper.Initialize(ref _preprocessorStates, states.ToImmutableAndFree());
            CVM.AHelper.Initialize(ref _preprocessorStateChangePositions, positions.ToImmutableAndFree());
        }
        ...
        private SyntaxTree WithChanges(SourceText newText, IList<TextChangeRange> changes)
        {
            if (changes == null)
            {
        ...
        public override FileLinePositionSpan GetMappedLineSpan(TextSpan span, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (_lazyLineDirectiveMap == null)
            {
                ...
                CVM.AHelper.CompareExchange(ref _lazyLineDirectiveMap, new CSharpLineDirectiveMap(this), null);
            }
        ...
        internal ReportDiagnostic GetPragmaDirectiveWarningState(string id, int position)
        {
            if (_lazyPragmaWarningStateMap == null)
            {
                ...
                CVM.AHelper.CompareExchange(ref _lazyPragmaWarningStateMap, new CSharpPragmaWarningStateMap(this), null);
            }
        ...
        internal bool? GetNullableDirectiveState(int position)
        {
            if (_lazyNullableDirectiveMap == null)
            {
                ...
                CVM.AHelper.CompareExchange(ref _lazyNullableDirectiveMap, NullableDirectiveMap.Create(this), null);
            }
